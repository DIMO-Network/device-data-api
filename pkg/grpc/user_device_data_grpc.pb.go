...
const (
	UserDeviceDataService_GetUserDeviceData_FullMethodName   = "/grpc.UserDeviceDataService/GetUserDeviceData"
	UserDeviceDataService_GetRawDeviceData_FullMethodName    = "/grpc.UserDeviceDataService/GetRawDeviceData"
	UserDeviceDataService_GetSignals_FullMethodName          = "/grpc.UserDeviceDataService/GetSignals"
	UserDeviceDataService_GetAvailableDates_FullMethodName   = "/grpc.UserDeviceDataService/GetAvailableDates"
	UserDeviceDataService_GetSummaryConnected_FullMethodName = "/grpc.UserDeviceDataService/GetSummaryConnected"
)
...
type UserDeviceDataServiceClient interface {
	...
	GetRawDeviceData(ctx context.Context, in *RawDeviceDataRequest, opts ...grpc.CallOption) (*RawDeviceDataResponse, error)
...
func (c *userDeviceDataServiceClient) GetUserDeviceData(ctx context.Context, in *UserDeviceDataRequest, opts ...grpc.CallOption) (*UserDeviceDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserDeviceDataService_GetUserDeviceData_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userDeviceDataServiceClient) GetRawDeviceData(ctx context.Context, in *RawDeviceDataRequest, opts ...grpc.CallOption) (*RawDeviceDataResponse, error) {
	out := new(RawDeviceDataResponse)
	err := c.cc.Invoke(ctx, UserDeviceDataService_GetRawDeviceData_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userDeviceDataServiceClient) GetSignals(ctx context.Context, in *SignalRequest, opts ...grpc.CallOption) (*SignalResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserDeviceDataService_GetSignals_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userDeviceDataServiceClient) GetAvailableDates(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*DateIdsResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserDeviceDataService_GetAvailableDates_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userDeviceDataServiceClient) GetSummaryConnected(ctx context.Context, in *SummaryConnectedRequest, opts ...grpc.CallOption) (*SummaryConnectedResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserDeviceDataService_GetSummaryConnected_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserDeviceDataServiceServer interface {
	...
	GetRawDeviceData(context.Context, *RawDeviceDataRequest) (*RawDeviceDataResponse, error)
...
func (UnimplementedUserDeviceDataServiceServer) GetRawDeviceData(context.Context, *RawDeviceDataRequest) (*RawDeviceDataResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRawDeviceData not implemented")
}
...
func _UserDeviceDataService_GetUserDeviceData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserDeviceDataService_GetUserDeviceData_FullMethodName,
	}
...
func _UserDeviceDataService_GetRawDeviceData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RawDeviceDataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserDeviceDataServiceServer).GetRawDeviceData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserDeviceDataService_GetRawDeviceData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserDeviceDataServiceServer).GetRawDeviceData(ctx, req.(*RawDeviceDataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserDeviceDataService_GetSignals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserDeviceDataService_GetSignals_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserDeviceDataService_GetAvailableDates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserDeviceDataService_GetAvailableDates_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserDeviceDataService_GetSummaryConnected_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserDeviceDataService_GetSummaryConnected_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var UserDeviceDataService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetRawDeviceData",
			Handler:    _UserDeviceDataService_GetRawDeviceData_Handler,
		},
		{
