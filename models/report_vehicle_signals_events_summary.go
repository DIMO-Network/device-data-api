...
func AddReportVehicleSignalsEventsSummaryHook(hookPoint boil.HookPoint, reportVehicleSignalsEventsSummaryHook ReportVehicleSignalsEventsSummaryHook) {
	...
	case boil.AfterSelectHook:
		reportVehicleSignalsEventsSummaryAfterSelectMu.Lock()
		...
		reportVehicleSignalsEventsSummaryAfterSelectMu.Unlock()
	case boil.BeforeInsertHook:
		reportVehicleSignalsEventsSummaryBeforeInsertMu.Lock()
		...
		reportVehicleSignalsEventsSummaryBeforeInsertMu.Unlock()
	case boil.AfterInsertHook:
		reportVehicleSignalsEventsSummaryAfterInsertMu.Lock()
		...
		reportVehicleSignalsEventsSummaryAfterInsertMu.Unlock()
	case boil.BeforeUpdateHook:
		reportVehicleSignalsEventsSummaryBeforeUpdateMu.Lock()
		...
		reportVehicleSignalsEventsSummaryBeforeUpdateMu.Unlock()
	case boil.AfterUpdateHook:
		reportVehicleSignalsEventsSummaryAfterUpdateMu.Lock()
		...
		reportVehicleSignalsEventsSummaryAfterUpdateMu.Unlock()
	case boil.BeforeDeleteHook:
		reportVehicleSignalsEventsSummaryBeforeDeleteMu.Lock()
		...
		reportVehicleSignalsEventsSummaryBeforeDeleteMu.Unlock()
	case boil.AfterDeleteHook:
		reportVehicleSignalsEventsSummaryAfterDeleteMu.Lock()
		...
		reportVehicleSignalsEventsSummaryAfterDeleteMu.Unlock()
	case boil.BeforeUpsertHook:
		reportVehicleSignalsEventsSummaryBeforeUpsertMu.Lock()
		...
		reportVehicleSignalsEventsSummaryBeforeUpsertMu.Unlock()
	case boil.AfterUpsertHook:
		reportVehicleSignalsEventsSummaryAfterUpsertMu.Lock()
		...
		reportVehicleSignalsEventsSummaryAfterUpsertMu.Unlock()
	}
}
...
func (o *ReportVehicleSignalsEventsSummary) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(reportVehicleSignalsEventsSummaryAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(reportVehicleSignalsEventsSummaryPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert report_vehicle_signals_events_summary, could not build conflict column list")
			}
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"device_data_api\".\"report_vehicle_signals_events_summary\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
// Exists checks if the ReportVehicleSignalsEventsSummary row exists.
func (o *ReportVehicleSignalsEventsSummary) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return ReportVehicleSignalsEventsSummaryExists(ctx, exec, o.DateID, o.IntegrationID, o.PowerTrainType)
}
