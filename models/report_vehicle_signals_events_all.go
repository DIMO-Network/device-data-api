...
func AddReportVehicleSignalsEventsAllHook(hookPoint boil.HookPoint, reportVehicleSignalsEventsAllHook ReportVehicleSignalsEventsAllHook) {
	...
	case boil.AfterSelectHook:
		reportVehicleSignalsEventsAllAfterSelectMu.Lock()
		...
		reportVehicleSignalsEventsAllAfterSelectMu.Unlock()
	case boil.BeforeInsertHook:
		reportVehicleSignalsEventsAllBeforeInsertMu.Lock()
		...
		reportVehicleSignalsEventsAllBeforeInsertMu.Unlock()
	case boil.AfterInsertHook:
		reportVehicleSignalsEventsAllAfterInsertMu.Lock()
		...
		reportVehicleSignalsEventsAllAfterInsertMu.Unlock()
	case boil.BeforeUpdateHook:
		reportVehicleSignalsEventsAllBeforeUpdateMu.Lock()
		...
		reportVehicleSignalsEventsAllBeforeUpdateMu.Unlock()
	case boil.AfterUpdateHook:
		reportVehicleSignalsEventsAllAfterUpdateMu.Lock()
		...
		reportVehicleSignalsEventsAllAfterUpdateMu.Unlock()
	case boil.BeforeDeleteHook:
		reportVehicleSignalsEventsAllBeforeDeleteMu.Lock()
		...
		reportVehicleSignalsEventsAllBeforeDeleteMu.Unlock()
	case boil.AfterDeleteHook:
		reportVehicleSignalsEventsAllAfterDeleteMu.Lock()
		...
		reportVehicleSignalsEventsAllAfterDeleteMu.Unlock()
	case boil.BeforeUpsertHook:
		reportVehicleSignalsEventsAllBeforeUpsertMu.Lock()
		...
		reportVehicleSignalsEventsAllBeforeUpsertMu.Unlock()
	case boil.AfterUpsertHook:
		reportVehicleSignalsEventsAllAfterUpsertMu.Lock()
		...
		reportVehicleSignalsEventsAllAfterUpsertMu.Unlock()
	}
}
...
func (o *ReportVehicleSignalsEventsAll) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(reportVehicleSignalsEventsAllAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(reportVehicleSignalsEventsAllPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert report_vehicle_signals_events_all, could not build conflict column list")
			}
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"device_data_api\".\"report_vehicle_signals_events_all\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
// Exists checks if the ReportVehicleSignalsEventsAll row exists.
func (o *ReportVehicleSignalsEventsAll) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return ReportVehicleSignalsEventsAllExists(ctx, exec, o.DateID, o.IntegrationID, o.DeviceMakeID, o.PropertyID, o.Model, o.Year)
}
