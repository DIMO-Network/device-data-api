...
func AddReportVehicleSignalsEventsTrackingHook(hookPoint boil.HookPoint, reportVehicleSignalsEventsTrackingHook ReportVehicleSignalsEventsTrackingHook) {
	...
	case boil.AfterSelectHook:
		reportVehicleSignalsEventsTrackingAfterSelectMu.Lock()
		...
		reportVehicleSignalsEventsTrackingAfterSelectMu.Unlock()
	case boil.BeforeInsertHook:
		reportVehicleSignalsEventsTrackingBeforeInsertMu.Lock()
		...
		reportVehicleSignalsEventsTrackingBeforeInsertMu.Unlock()
	case boil.AfterInsertHook:
		reportVehicleSignalsEventsTrackingAfterInsertMu.Lock()
		...
		reportVehicleSignalsEventsTrackingAfterInsertMu.Unlock()
	case boil.BeforeUpdateHook:
		reportVehicleSignalsEventsTrackingBeforeUpdateMu.Lock()
		...
		reportVehicleSignalsEventsTrackingBeforeUpdateMu.Unlock()
	case boil.AfterUpdateHook:
		reportVehicleSignalsEventsTrackingAfterUpdateMu.Lock()
		...
		reportVehicleSignalsEventsTrackingAfterUpdateMu.Unlock()
	case boil.BeforeDeleteHook:
		reportVehicleSignalsEventsTrackingBeforeDeleteMu.Lock()
		...
		reportVehicleSignalsEventsTrackingBeforeDeleteMu.Unlock()
	case boil.AfterDeleteHook:
		reportVehicleSignalsEventsTrackingAfterDeleteMu.Lock()
		...
		reportVehicleSignalsEventsTrackingAfterDeleteMu.Unlock()
	case boil.BeforeUpsertHook:
		reportVehicleSignalsEventsTrackingBeforeUpsertMu.Lock()
		...
		reportVehicleSignalsEventsTrackingBeforeUpsertMu.Unlock()
	case boil.AfterUpsertHook:
		reportVehicleSignalsEventsTrackingAfterUpsertMu.Lock()
		...
		reportVehicleSignalsEventsTrackingAfterUpsertMu.Unlock()
	}
}
...
func (o *ReportVehicleSignalsEventsTracking) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(reportVehicleSignalsEventsTrackingAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(reportVehicleSignalsEventsTrackingPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert report_vehicle_signals_events_tracking, could not build conflict column list")
			}
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"device_data_api\".\"report_vehicle_signals_events_tracking\"", updateOnConflict, ret, update, conflict, insert, opts...)
