...
type UserDeviceDatum struct {
	...
	LastLocationEventAt null.Time `boil:"last_location_event_at" json:"last_location_event_at,omitempty" toml:"last_location_event_at" yaml:"last_location_event_at,omitempty"`
	LastOdb2EventAt     null.Time `boil:"last_odb2_event_at" json:"last_odb2_event_at,omitempty" toml:"last_odb2_event_at" yaml:"last_odb2_event_at,omitempty"`
...
var UserDeviceDatumColumns = struct {
	...
	CreatedAt           string
	UpdatedAt           string
	LastLocationEventAt string
	LastOdb2EventAt     string
}{
	...
	LastLocationEventAt: "last_location_event_at",
	LastOdb2EventAt:     "last_odb2_event_at",
}
...
var UserDeviceDatumTableColumns = struct {
	...
	LastLocationEventAt: "user_device_data.last_location_event_at",
	LastOdb2EventAt:     "user_device_data.last_odb2_event_at",
}
...
var UserDeviceDatumWhere = struct {
	...
	LastLocationEventAt whereHelpernull_Time
	LastOdb2EventAt     whereHelpernull_Time
}{
	...
	IntegrationID:       whereHelperstring{field: "\"device_data_api\".\"user_device_data\".\"integration_id\""},
	...
	LastLocationEventAt: whereHelpernull_Time{field: "\"device_data_api\".\"user_device_data\".\"last_location_event_at\""},
	LastOdb2EventAt:     whereHelpernull_Time{field: "\"device_data_api\".\"user_device_data\".\"last_odb2_event_at\""},
}
...
var (
	userDeviceDatumAllColumns            = []string{"user_device_id", "error_data", "integration_id", "signals", "created_at", "updated_at", "last_location_event_at", "last_odb2_event_at"}
	userDeviceDatumColumnsWithoutDefault = []string{"user_device_id", "integration_id"}
	userDeviceDatumColumnsWithDefault    = []string{"error_data", "signals", "created_at", "updated_at", "last_location_event_at", "last_odb2_event_at"}
...
func FindUserDeviceDatum(ctx context.Context, exec boil.ContextExecutor, userDeviceID string, integrationID string, selectCols ...string) (*UserDeviceDatum, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"device_data_api\".\"user_device_data\" where \"user_device_id\"=$1 AND \"integration_id\"=$2", sel,
	)
...
func (o *UserDeviceDatum) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"device_data_api\".\"user_device_data\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func (o *UserDeviceDatum) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"device_data_api\".\"user_device_data\" WHERE \"user_device_id\"=$1 AND \"integration_id\"=$2"
...
func UserDeviceDatumExists(ctx context.Context, exec boil.ContextExecutor, userDeviceID string, integrationID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"device_data_api\".\"user_device_data\" where \"user_device_id\"=$1 AND \"integration_id\"=$2 limit 1)"
