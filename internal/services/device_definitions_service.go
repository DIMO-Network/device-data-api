...
type DeviceDefinitionsAPIService interface {
	GetDeviceDefinition(ctx context.Context, id string) (*pb.GetDeviceDefinitionResponse, error)
}
...
func (dda *deviceDefinitionsAPIService) GetDeviceDefinition(ctx context.Context, id string) (*pb.GetDeviceDefinitionResponse, error) {
